...
void Level2::Init()
{
    Object::sceneObject(2);
    Bullet::sceneBullet(2);
...
void Level2::enemyUpdate(double dt)
{
    ...
    for (vector<Enemy*>::iterator it = enemyStorage.begin(); it != enemyStorage.end(); it++)
    {
        ...
        {
            if ((*factoryIt)->type == Level2::GEO_LIGHTBALL3)   //BULLET INTERACTION WITH ENEMY
            {
...
void Level2::RenderText(Mesh* mesh, std::string text, Color color)
{
