...
void Level4::Init()
{
    Object::sceneObject(4);
    Bullet::sceneBullet(4);
...
void Level4::enemyUpdate(double dt)
{
    ...
    for (vector<Enemy*>::iterator it = enemyStorage.begin(); it != enemyStorage.end(); it++)
    {
        ...
        {
            if ((*factoryIt)->type == Level4::GEO_LIGHTBALL3)   //BULLET INTERACTION WITH ENEMY
            {
...
void Level4::RenderText(Mesh* mesh, std::string text, Color color)
{
